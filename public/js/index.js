...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) { "use strict"; var e = t.fn.jquery.split(" ")[0].split("."); if (e[0] < 2 && e[1] < 9 || 1 == e[0] && 9 == e[1] && e[2] < 1 || e[0] > 3) throw new Error("Bootstrap's JavaScript requires jQuery version 1.9.1 or higher, but lower than version 4") }(jQuery), + function(t) {
    ...
    i.VERSION = "3.3.7", i.DEFAULTS = { loadingText: "loading..." }, i.prototype.setState = function(e) {
        var i = "disabled",
            ...
            s = o.data();
        e += "Text", null == s.resetText && o.data("resetText", o[n]()), setTimeout(t.proxy(function() { o[n](null == s[e] ? this.options[e] : s[e]), "loadingText" == e ? (this.isLoading = !0, o.addClass(i).attr(i, i).prop(i, !0)) : this.isLoading && (this.isLoading = !1, o.removeClass(i).removeAttr(i).prop(i, !1)) }, this), 0)
    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 150, i.DEFAULTS = { animation: !0, placement: "top", selector: !1, template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover focus", title: "", delay: 0, html: !1, container: !1, viewport: { selector: "body", padding: 0 } }, i.prototype.init = function(e, i, o) {
        ...
        function o() { "in" != n.hoverState && s.detach(), n.$element && n.$element.removeAttr("aria-describedby").trigger("hidden.bs." + n.type), e && e() }
        var n = this,
            s = t(this.$tip),
...
(function($) {
    $.fn.jRating = function(op) {
        var defaults = {
            ...
            bigStarsPath: 'plugins/jRating/jquery/icons/stars.png', // path of the icon stars.png
            smallStarsPath: 'plugins/jRating/jquery/icons/small.png', // path of the icon small.png
            phpPath: 'ajax/index.php?method=rating', // path of the php file jRating.php
    ...
    return function(t) {
        ...
        function n(t, e) {
            var n = t[1] || "",
                r = t[3];
            if (!r) return n;
            if (e && "function" == typeof btoa) { var i = o(r); return [n].concat(r.sources.map(function(t) { return "" })).concat([i]).join("\n") }
            return [n].join("\n")
        }
...
(function($, h, i, j) {
    var k = "easyTicker",
        defaults = { direction: 'up', easing: 'swing', speed: 'slow', interval: 2000, height: 'auto', visible: 0, mousePause: 1, controls: { up: '', down: '', toggle: '', playText: 'Play', stopText: 'Stop' } };
    ...
    function EasyTicker(f, g) {
        ...
        init();
        start();
        $([h, i]).off('focus.jqet').on('focus.jqet', function() { s.winFocus = 1 }).off('blur.jqet').on('blur.jqet', function() { s.winFocus = 0 });
        if (s.opts.mousePause == 1) {
            s.elem.mouseenter(function() {
                s.timerTemp = s.timer;
                stop()
            }).mouseleave(function() { if (s.timerTemp !== 0) start() })
        }
        ...
        function start() {
            s.timer = setInterval(function() { if (s.winFocus == 1) { move(s.opts.direction) } }, s.opts.interval);
        ...
        function fullHeight() {
            ...
            s.targ.children().each(function() { a += $(this).outerHeight() });
            s.elem.css({ 'display': b, 'height': a })
        }

        function visHeight(a) {
            var b = 0;
            s.targ.children(':lt(' + s.opts.visible + ')').each(function() { b += $(this).outerHeight() });
            if (a == 1) { s.elem.stop(true, true).animate({ height: b }, s.opts.speed) } else { s.elem.css('height', b) }
        }
        ...
        function adjHeight() {
            if (s.opts.height == 'auto' && s.opts.visible != 0) {
                ...
                visHeight(anim)
            } else if (s.opts.height == 'auto') { fullHeight() }
        }
        return { up: function() { moveDir('up') }, down: function() { moveDir('down') }, start: start, stop: stop, options: s.opts }
    }
    $.fn[k] = function(a) { return this.each(function() { if (!$.data(this, k)) { $.data(this, k, new EasyTicker(this, a)) } }) }
})(jQuery, window, document);;
(function($, h, i, j) {
    var k = "easyTicker",
        defaults = { direction: 'up', easing: 'swing', speed: 'slow', interval: 2000, height: 'auto', visible: 0, mousePause: 1, controls: { up: '', down: '', toggle: '', playText: 'Play', stopText: 'Stop' } };
...
! function(t) {
    var e = -1,
        a = -1,
        o = function(t) { return parseFloat(t) || 0 },
        i = function(e) {
            var a = 1,
                i = t(e),
                n = null,
        ...
        n = function(e) { var a = { byRow: !0, property: "height", target: null, remove: !1 }; return "object" == typeof e ? t.extend(a, e) : ("boolean" == typeof e ? a.byRow = e : "remove" === e && (a.remove = !0), a) },
        r = t.fn.matchHeight = function(e) {
            var a = n(e);
            if (a.remove) { var o = this; return this.css(a.property, ""), t.each(r._groups, function(t, e) { e.elements = e.elements.not(o) }), this }
    ...
    r.version = "master", r._groups = [], r._throttle = 80, r._maintainScroll = !1, r._beforeUpdate = null, r._afterUpdate = null, r._rows = i, r._parse = o, r._parseOptions = n, r._apply = function(e, a) {
        ...
        return d.each(function() {
            ...
            var e = t(this),
                a = e.css("display");
            "inline-block" !== a && "flex" !== a && "inline-flex" !== a && (a = "block"), e.data("style-cache", e.attr("style")), e.css({ display: a, "padding-top": "0", "padding-bottom": "0", "margin-top": "0", "margin-bottom": "0", "border-top-width": "0", "border-bottom-width": "0", height: "100px", overflow: "hidden" })
            ...
            i.each(function() {
                ...
                s.target && e.is(s.target) || ("border-box" !== e.css("box-sizing") && (a += o(e.css("border-top-width")) + o(e.css("border-bottom-width")),
                    a += o(e.css("padding-top")) + o(e.css("padding-bottom"))), e.css(s.property, n - a + "px"))
            })
        }), d.each(function() {
            var e = t(this);
    ...
    var s = function(e) {
        r._beforeUpdate && r._beforeUpdate(e, r._groups),
            t.each(r._groups, function() { r._apply(this.elements, this.options) }), r._afterUpdate && r._afterUpdate(e, r._groups)
    };
...
(function(e) {
    jQuery(document).ready(function() {
        ...
        jQuery(".tablet.inactive").click(function() {
            ...
            jQuery(".theme-wrapper").addClass("iOSdevice").removeClass("landscape").addClass("portrait").removeClass("notiOS");
            jQuery(".respond a.tablet").click(function() {
                if (jQuery(this).hasClass("activePortrait")) {
                    jQuery(this).removeClass("activePortrait");
                    jQuery(this).addClass("activeLandscape");
        ...
        jQuery(".respond a.desktop").click(function() {
            ...
            jQuery(".respond").find("li a").not(this).removeClass("activeLandscape").addClass("activePortrait");
        });
        jQuery(".respond a").click(function() {
            ...
            jQuery(".respond").find("a").not(this).not(".respond a:first").removeClass("activeLandscape").addClass("activePortrait");
        });
        jQuery("#theme-demo").on("load", function() {
...
(function(f, h) {
    function k(b) {
        ...
        if (b in g.style) c = b;
            ...
            for (var s = 0; s < e.length; s++)
                if (a = e[s] + d, a in g.style) { c = a; break } return f.support[b] = c
    }
    ...
    u.prototype = {
        imageLoad: function() {
            for (var b = this, a = b.images, c = 0; c < a.length; c++) { var d = a[c]; if (d.width === h || d.complete !== h && !d.complete) return setTimeout(function() { b.imageLoad() }, 50), !1 }
            b.init()
        },
        init: function() {
        ...
        slideNormal: function(b) {
            ...
            d.show().stop().animate({ top: 0, left: 0 }, this.settings.animationSpeed, this.settings.fallbackEasing, function() {
        ...
        showTitle: function(b) { b.data("title") && b.data("title").slideDown(this.settings.titleSpeed, this.settings.titleEasing) },
        rotateCubes: function() {
            this.items.eq(this.prevItem).hide();
            this.items.find(".cs-title").hide();
            for (var b = this, a = 0; a < this.numCubes; ++a) this.cubes[a].rotate(a, b.currItem, function(a) { a === b.numCubes - 1 && (b.slider.css("overflow", "hidden"), b.animBox.remove(), b.showTitle(b.items.eq(b.currItem).css("display", "block")), b.onFinish()) })
        },
        createCubes: function(b) {
            ...
            b = { width: this.width, height: this.height, orientation: a, css: this.cssProps, images: this.images, rows: this.rows, cols: this.cols, dir: b, settings: this.settings };
    ...
    v.prototype = {
        ...
        changeImage: function(b) {
            ...
            this.cube.children().eq(a).css({ "background-image": "url(" + this.images.eq(b).attr("src") + ")", "background-position": "-" + this.x + "px -" + this.y + "px" })
        },
        rotate: function(b, a, c) {
            ...
            setTimeout(function() {
                ...
                e.cube.css(g.TR, f).animate(h, d.animationSpeed / 2).animate(k, d.animationSpeed / 2, function() { c && c.call(this, b) })
            }, d.cubeSync * b)
        }
    };
    var x = { orientation: "v", perspective: 1200, cubesNum: { rows: 1, cols: 1 }, random: !1, spreadPixel: 0, backfacesColor: "#222", cubeSync: 100, animationSpeed: 800, easing: "ease", fallbackEasing: "easeOutExpo", autoplay: !1, autoplayInterval: 2E3, mode3d: "auto", arrows: !0, navigation: !0, addShadow: !0, play: !0, titleSpeed: 300, titleEasing: "easeOutExpo" },
        t = {
            init: function(b) {
                return this.each(function() {
                    var a = f.extend({}, x, b),
            ...
            enable: function() { return this.each(function() { f(this).data("CS").enable(!0) }) },
            disable: function() { return this.each(function() { f(this).data("CS").enable(!1) }) },
            destroy: function() {
                return this.each(function() {
                    var b = f(this);
                    b.data("CS");
            ...
            option: function(b, a) { return this.each(function() { return f(this).data("CS").options(b, a) }) }
        };
    ...
    f.extend(f.easing, {
        ...
        easeInExpo: function(b, a, c, d, e) { return 0 == a ? c : d * Math.pow(2, 10 * (a / e - 1)) + c },
        easeOutExpo: function(b, a, c, d, e) { return a == e ? c + d : d * (-Math.pow(2, -10 * a / e) + 1) + c },
        easeInOutExpo: function(b, a, c, d, e) { return 0 == a ? c : a == e ? c + d : 1 > (a /= e / 2) ? d / 2 * Math.pow(2, 10 * (a - 1)) + c : d / 2 * (-Math.pow(2, -10 * --a) + 2) + c },
        ...
        easeInOutCirc: function(b, a, c, d, e) { return 1 > (a /= e / 2) ? -d / 2 * (Math.sqrt(1 - a * a) - 1) + c : d / 2 * (Math.sqrt(1 - (a -= 2) * a) + 1) + c },
        ...
        easeInBack: function(b, a, c, d, e, f) { f == h && (f = 1.70158); return d * (a /= e) * a * ((f + 1) * a - f) + c },
        easeOutBack: function(b, a, c, d, e, f) { f == h && (f = 1.70158); return d * ((a = a / e - 1) * a * ((f + 1) * a + f) + 1) + c },
        easeInOutBack: function(b, a, c, d, e, f) { f == h && (f = 1.70158); return 1 > (a /= e / 2) ? d / 2 * a * a * (((f *= 1.525) + 1) * a - f) + c : d / 2 * ((a -= 2) * a * (((f *= 1.525) + 1) * a + f) + 2) + c },
        easeInBounce: function(b, a, c, d, e) { return d - f.easing.easeOutBounce(b, e - a, 0, d, e) + c },
        easeOutBounce: function(b, a, c, d, e) { return (a /= e) < 1 / 2.75 ? 7.5625 * d * a * a + c : a < 2 / 2.75 ? d * (7.5625 * (a -= 1.5 / 2.75) * a + 0.75) + c : a < 2.5 / 2.75 ? d * (7.5625 * (a -= 2.25 / 2.75) * a + 0.9375) + c : d * (7.5625 * (a -= 2.625 / 2.75) * a + 0.984375) + c },
        easeInOutBounce: function(b, a, c, d, e) { return a < e / 2 ? 0.5 * f.easing.easeInBounce(b, 2 * a, 0, d, e) + c : 0.5 * f.easing.easeOutBounce(b, 2 * a - e, 0, d, e) + 0.5 * d + c }
    })
})(jQuery);
var slice = [].slice;
...
(function($, window) {
    ...
    window.Starrr = Starrr = (function() {
        ...
        Starrr.prototype.syncRating = function(rating) {
            ...
            // Code them de lay rating bang data
            if (typeof this.options.rating === 'string') {
                rating = this.$el.data(this.options.rating);
            }
            $stars = this.getStars();
            results = [];
...
! function(a) { "function" == typeof define && define.amd ? define(["jquery"], a) : "object" == typeof module && module.exports ? module.exports = function(b, c) { return void 0 === c && (c = "undefined" != typeof window ? require("jquery") : require("jquery")(b)), a(c), c } : a(jQuery) }(function(a) {
    var b = function() {
            ...
            return function() {
                ...
                }), b.define("select2/diacritics", [], function() { return { "â’¶": "A", "ï¼¡": "A", "Ã€": "A", "Ã": "A", "Ã‚": "A", "áº¦": "A", "áº¤": "A", "áºª": "A", "áº¨": "A", "Ãƒ": "A", "Ä€": "A", "Ä‚": "A", "áº°": "A", "áº®": "A", "áº´": "A", "áº²": "A", "È¦": "A", "Ç ": "A", "Ã„": "A", "Çž": "A", "áº¢": "A", "Ã…": "A", "Çº": "A", "Ç": "A", "È€": "A", "È‚": "A", "áº ": "A", "áº¬": "A", "áº¶": "A", "á¸€": "A", "Ä„": "A", "Èº": "A", "â±¯": "A", "êœ²": "AA", "Ã†": "AE", "Ç¼": "AE", "Ç¢": "AE", "êœ´": "AO", "êœ¶": "AU", "êœ¸": "AV", "êœº": "AV", "êœ¼": "AY", "â’·": "B", "ï¼¢": "B", "á¸‚": "B", "á¸„": "B", "á¸†": "B", "Éƒ": "B", "Æ‚": "B", "Æ": "B", "â’¸": "C", "ï¼£": "C", "Ä†": "C", "Äˆ": "C", "ÄŠ": "C", "ÄŒ": "C", "Ã‡": "C", "á¸ˆ": "C", "Æ‡": "C", "È»": "C", "êœ¾": "C", "â’¹": "D", "ï¼¤": "D", "á¸Š": "D", "ÄŽ": "D", "á¸Œ": "D", "á¸": "D", "á¸’": "D", "á¸Ž": "D", "Ä": "D", "Æ‹": "D", "ÆŠ": "D", "Æ‰": "D", "ê¹": "D", "Ç±": "DZ", "Ç„": "DZ", "Ç²": "Dz", "Ç…": "Dz", "â’º": "E", "ï¼¥": "E", "Ãˆ": "E", "Ã‰": "E", "ÃŠ": "E", "á»€": "E", "áº¾": "E", "á»„": "E", "á»‚": "E", "áº¼": "E", "Ä’": "E", "á¸”": "E", "á¸–": "E", "Ä”": "E", "Ä–": "E", "Ã‹": "E", "áºº": "E", "Äš": "E", "È„": "E", "È†": "E", "áº¸": "E", "á»†": "E", "È¨": "E", "á¸œ": "E", "Ä˜": "E", "á¸˜": "E", "á¸š": "E", "Æ": "E", "ÆŽ": "E", "â’»": "F", "ï¼¦": "F", "á¸ž": "F", "Æ‘": "F", "ê»": "F", "â’¼": "G", "ï¼§": "G", "Ç´": "G", "Äœ": "G", "á¸ ": "G", "Äž": "G", "Ä ": "G", "Ç¦": "G", "Ä¢": "G", "Ç¤": "G", "Æ“": "G", "êž ": "G", "ê½": "G", "ê¾": "G", "â’½": "H", "ï¼¨": "H", "Ä¤": "H", "á¸¢": "H", "á¸¦": "H", "Èž": "H", "á¸¤": "H", "á¸¨": "H", "á¸ª": "H", "Ä¦": "H", "â±§": "H", "â±µ": "H", "êž": "H", "â’¾": "I", "ï¼©": "I", "ÃŒ": "I", "Ã": "I", "ÃŽ": "I", "Ä¨": "I", "Äª": "I", "Ä¬": "I", "Ä°": "I", "Ã": "I", "á¸®": "I", "á»ˆ": "I", "Ç": "I", "Èˆ": "I", "ÈŠ": "I", "á»Š": "I", "Ä®": "I", "á¸¬": "I", "Æ—": "I", "â’¿": "J", "ï¼ª": "J", "Ä´": "J", "Éˆ": "J", "â“€": "K", "ï¼«": "K", "á¸°": "K", "Ç¨": "K", "á¸²": "K", "Ä¶": "K", "á¸´": "K", "Æ˜": "K", "â±©": "K", "ê€": "K", "ê‚": "K", "ê„": "K", "êž¢": "K", "â“": "L", "ï¼¬": "L", "Ä¿": "L", "Ä¹": "L", "Ä½": "L", "á¸¶": "L", "á¸¸": "L", "Ä»": "L", "á¸¼": "L", "á¸º": "L", "Å": "L", "È½": "L", "â±¢": "L", "â± ": "L", "êˆ": "L", "ê†": "L", "êž€": "L", "Ç‡": "LJ", "Çˆ": "Lj", "â“‚": "M", "ï¼­": "M", "á¸¾": "M", "á¹€": "M", "á¹‚": "M", "â±®": "M", "Æœ": "M", "â“ƒ": "N", "ï¼®": "N", "Ç¸": "N", "Åƒ": "N", "Ã‘": "N", "á¹„": "N", "Å‡": "N", "á¹†": "N", "Å…": "N", "á¹Š": "N", "á¹ˆ": "N", "È ": "N", "Æ": "N", "êž": "N", "êž¤": "N", "ÇŠ": "NJ", "Ç‹": "Nj", "â“„": "O", "ï¼¯": "O", "Ã’": "O", "Ã“": "O", "Ã”": "O", "á»’": "O", "á»": "O", "á»–": "O", "á»”": "O", "Ã•": "O", "á¹Œ": "O", "È¬": "O", "á¹Ž": "O", "ÅŒ": "O", "á¹": "O", "á¹’": "O", "ÅŽ": "O", "È®": "O", "È°": "O", "Ã–": "O", "Èª": "O", "á»Ž": "O", "Å": "O", "Ç‘": "O", "ÈŒ": "O", "ÈŽ": "O", "Æ ": "O", "á»œ": "O", "á»š": "O", "á» ": "O", "á»ž": "O", "á»¢": "O", "á»Œ": "O", "á»˜": "O", "Çª": "O", "Ç¬": "O", "Ã˜": "O", "Ç¾": "O", "Æ†": "O", "ÆŸ": "O", "êŠ": "O", "êŒ": "O", "Æ¢": "OI", "êŽ": "OO", "È¢": "OU", "â“…": "P", "ï¼°": "P", "á¹”": "P", "á¹–": "P", "Æ¤": "P", "â±£": "P", "ê": "P", "ê’": "P", "ê”": "P", "â“†": "Q", "ï¼±": "Q", "ê–": "Q", "ê˜": "Q", "ÉŠ": "Q", "â“‡": "R", "ï¼²": "R", "Å”": "R", "á¹˜": "R", "Å˜": "R", "È": "R", "È’": "R", "á¹š": "R", "á¹œ": "R", "Å–": "R", "á¹ž": "R", "ÉŒ": "R", "â±¤": "R", "êš": "R", "êž¦": "R", "êž‚": "R", "â“ˆ": "S", "ï¼³": "S", "áºž": "S", "Åš": "S", "á¹¤": "S", "Åœ": "S", "á¹ ": "S", "Å ": "S", "á¹¦": "S", "á¹¢": "S", "á¹¨": "S", "È˜": "S", "Åž": "S", "â±¾": "S", "êž¨": "S", "êž„": "S", "â“‰": "T", "ï¼´": "T", "á¹ª": "T", "Å¤": "T", "á¹¬": "T", "Èš": "T", "Å¢": "T", "á¹°": "T", "á¹®": "T", "Å¦": "T", "Æ¬": "T", "Æ®": "T", "È¾": "T", "êž†": "T", "êœ¨": "TZ", "â“Š": "U", "ï¼µ": "U", "Ã™": "U", "Ãš": "U", "Ã›": "U", "Å¨": "U", "á¹¸": "U", "Åª": "U", "á¹º": "U", "Å¬": "U", "Ãœ": "U", "Ç›": "U", "Ç—": "U", "Ç•": "U", "Ç™": "U", "á»¦": "U", "Å®": "U", "Å°": "U", "Ç“": "U", "È”": "U", "È–": "U", "Æ¯": "U", "á»ª": "U", "á»¨": "U", "á»®": "U", "á»¬": "U", "á»°": "U", "á»¤": "U", "á¹²": "U", "Å²": "U", "á¹¶": "U", "á¹´": "U", "É„": "U", "â“‹": "V", "ï¼¶": "V", "á¹¼": "V", "á¹¾": "V", "Æ²": "V", "êž": "V", "É…": "V", "ê ": "VY", "â“Œ": "W", "ï¼·": "W", "áº€": "W", "áº‚": "W", "Å´": "W", "áº†": "W", "áº„": "W", "áºˆ": "W", "â±²": "W", "â“": "X", "ï¼¸": "X", "áºŠ": "X", "áºŒ": "X", "â“Ž": "Y", "ï¼¹": "Y", "á»²": "Y", "Ã": "Y", "Å¶": "Y", "á»¸": "Y", "È²": "Y", "áºŽ": "Y", "Å¸": "Y", "á»¶": "Y", "á»´": "Y", "Æ³": "Y", "ÉŽ": "Y", "á»¾": "Y", "â“": "Z", "ï¼º": "Z", "Å¹": "Z", "áº": "Z", "Å»": "Z", "Å½": "Z", "áº’": "Z", "áº”": "Z", "Æµ": "Z", "È¤": "Z", "â±¿": "Z", "â±«": "Z", "ê¢": "Z", "â“": "a", "ï½": "a", "áºš": "a", "Ã ": "a", "Ã¡": "a", "Ã¢": "a", "áº§": "a", "áº¥": "a", "áº«": "a", "áº©": "a", "Ã£": "a", "Ä": "a", "Äƒ": "a", "áº±": "a", "áº¯": "a", "áºµ": "a", "áº³": "a", "È§": "a", "Ç¡": "a", "Ã¤": "a", "ÇŸ": "a", "áº£": "a", "Ã¥": "a", "Ç»": "a", "ÇŽ": "a", "È": "a", "Èƒ": "a", "áº¡": "a", "áº­": "a", "áº·": "a", "á¸": "a", "Ä…": "a", "â±¥": "a", "É": "a", "êœ³": "aa", "Ã¦": "ae", "Ç½": "ae", "Ç£": "ae", "êœµ": "ao", "êœ·": "au", "êœ¹": "av", "êœ»": "av", "êœ½": "ay", "â“‘": "b", "ï½‚": "b", "á¸ƒ": "b", "á¸…": "b", "á¸‡": "b", "Æ€": "b", "Æƒ": "b", "É“": "b", "â“’": "c", "ï½ƒ": "c", "Ä‡": "c", "Ä‰": "c", "Ä‹": "c", "Ä": "c", "Ã§": "c", "á¸‰": "c", "Æˆ": "c", "È¼": "c", "êœ¿": "c", "â†„": "c", "â““": "d", "ï½„": "d", "á¸‹": "d", "Ä": "d", "á¸": "d", "á¸‘": "d", "á¸“": "d", "á¸": "d", "Ä‘": "d", "ÆŒ": "d", "É–": "d", "É—": "d", "êº": "d", "Ç³": "dz", "Ç†": "dz", "â“”": "e", "ï½…": "e", "Ã¨": "e", "Ã©": "e", "Ãª": "e", "á»": "e", "áº¿": "e", "á»…": "e", "á»ƒ": "e", "áº½": "e", "Ä“": "e", "á¸•": "e", "á¸—": "e", "Ä•": "e", "Ä—": "e", "Ã«": "e", "áº»": "e", "Ä›": "e", "È…": "e", "È‡": "e", "áº¹": "e", "á»‡": "e", "È©": "e", "á¸": "e", "Ä™": "e", "á¸™": "e", "á¸›": "e", "É‡": "e", "É›": "e", "Ç": "e", "â“•": "f", "ï½†": "f", "á¸Ÿ": "f", "Æ’": "f", "ê¼": "f", "â“–": "g", "ï½‡": "g", "Çµ": "g", "Ä": "g", "á¸¡": "g", "ÄŸ": "g", "Ä¡": "g", "Ç§": "g", "Ä£": "g", "Ç¥": "g", "É ": "g", "êž¡": "g", "áµ¹": "g", "ê¿": "g", "â“—": "h", "ï½ˆ": "h", "Ä¥": "h", "á¸£": "h", "á¸§": "h", "ÈŸ": "h", "á¸¥": "h", "á¸©": "h", "á¸«": "h", "áº–": "h", "Ä§": "h", "â±¨": "h", "â±¶": "h", "É¥": "h", "Æ•": "hv", "â“˜": "i", "ï½‰": "i", "Ã¬": "i", "Ã­": "i", "Ã®": "i", "Ä©": "i", "Ä«": "i", "Ä­": "i", "Ã¯": "i", "á¸¯": "i", "á»‰": "i", "Ç": "i", "È‰": "i", "È‹": "i", "á»‹": "i", "Ä¯": "i", "á¸­": "i", "É¨": "i", "Ä±": "i", "â“™": "j", "ï½Š": "j", "Äµ": "j", "Ç°": "j", "É‰": "j", "â“š": "k", "ï½‹": "k", "á¸±": "k", "Ç©": "k", "á¸³": "k", "Ä·": "k", "á¸µ": "k", "Æ™": "k", "â±ª": "k", "ê": "k", "êƒ": "k", "ê…": "k", "êž£": "k", "â“›": "l", "ï½Œ": "l", "Å€": "l", "Äº": "l", "Ä¾": "l", "á¸·": "l", "á¸¹": "l", "Ä¼": "l", "á¸½": "l", "á¸»": "l", "Å¿": "l", "Å‚": "l", "Æš": "l", "É«": "l", "â±¡": "l", "ê‰": "l", "êž": "l", "ê‡": "l", "Ç‰": "lj", "â“œ": "m", "ï½": "m", "á¸¿": "m", "á¹": "m", "á¹ƒ": "m", "É±": "m", "É¯": "m", "â“": "n", "ï½Ž": "n", "Ç¹": "n", "Å„": "n", "Ã±": "n", "á¹…": "n", "Åˆ": "n", "á¹‡": "n", "Å†": "n", "á¹‹": "n", "á¹‰": "n", "Æž": "n", "É²": "n", "Å‰": "n", "êž‘": "n", "êž¥": "n", "ÇŒ": "nj", "â“ž": "o", "ï½": "o", "Ã²": "o", "Ã³": "o", "Ã´": "o", "á»“": "o", "á»‘": "o", "á»—": "o", "á»•": "o", "Ãµ": "o", "á¹": "o", "È­": "o", "á¹": "o", "Å": "o", "á¹‘": "o", "á¹“": "o", "Å": "o", "È¯": "o", "È±": "o", "Ã¶": "o", "È«": "o", "á»": "o", "Å‘": "o", "Ç’": "o", "È": "o", "È": "o", "Æ¡": "o", "á»": "o", "á»›": "o", "á»¡": "o", "á»Ÿ": "o", "á»£": "o", "á»": "o", "á»™": "o", "Ç«": "o", "Ç­": "o", "Ã¸": "o", "Ç¿": "o", "É”": "o", "ê‹": "o", "ê": "o", "Éµ": "o", "Æ£": "oi", "È£": "ou", "ê": "oo", "â“Ÿ": "p", "ï½": "p", "á¹•": "p", "á¹—": "p", "Æ¥": "p", "áµ½": "p", "ê‘": "p", "ê“": "p", "ê•": "p", "â“ ": "q", "ï½‘": "q", "É‹": "q", "ê—": "q", "ê™": "q", "â“¡": "r", "ï½’": "r", "Å•": "r", "á¹™": "r", "Å™": "r", "È‘": "r", "È“": "r", "á¹›": "r", "á¹": "r", "Å—": "r", "á¹Ÿ": "r", "É": "r", "É½": "r", "ê›": "r", "êž§": "r", "êžƒ": "r", "â“¢": "s", "ï½“": "s", "ÃŸ": "s", "Å›": "s", "á¹¥": "s", "Å": "s", "á¹¡": "s", "Å¡": "s", "á¹§": "s", "á¹£": "s", "á¹©": "s", "È™": "s", "ÅŸ": "s", "È¿": "s", "êž©": "s", "êž…": "s", "áº›": "s", "â“£": "t", "ï½”": "t", "á¹«": "t", "áº—": "t", "Å¥": "t", "á¹­": "t", "È›": "t", "Å£": "t", "á¹±": "t", "á¹¯": "t", "Å§": "t", "Æ­": "t", "Êˆ": "t", "â±¦": "t", "êž‡": "t", "êœ©": "tz", "â“¤": "u", "ï½•": "u", "Ã¹": "u", "Ãº": "u", "Ã»": "u", "Å©": "u", "á¹¹": "u", "Å«": "u", "á¹»": "u", "Å­": "u", "Ã¼": "u", "Çœ": "u", "Ç˜": "u", "Ç–": "u", "Çš": "u", "á»§": "u", "Å¯": "u", "Å±": "u", "Ç”": "u", "È•": "u", "È—": "u", "Æ°": "u", "á»«": "u", "á»©": "u", "á»¯": "u", "á»­": "u", "á»±": "u", "á»¥": "u", "á¹³": "u", "Å³": "u", "á¹·": "u", "á¹µ": "u", "Ê‰": "u", "â“¥": "v", "ï½–": "v", "á¹½": "v", "á¹¿": "v", "Ê‹": "v", "êŸ": "v", "ÊŒ": "v", "ê¡": "vy", "â“¦": "w", "ï½—": "w", "áº": "w", "áºƒ": "w", "Åµ": "w", "áº‡": "w", "áº…": "w", "áº˜": "w", "áº‰": "w", "â±³": "w", "â“§": "x", "ï½˜": "x", "áº‹": "x", "áº": "x", "â“¨": "y", "ï½™": "y", "á»³": "y", "Ã½": "y", "Å·": "y", "á»¹": "y", "È³": "y", "áº": "y", "Ã¿": "y", "á»·": "y", "áº™": "y", "á»µ": "y", "Æ´": "y", "É": "y", "á»¿": "y", "â“©": "z", "ï½š": "z", "Åº": "z", "áº‘": "z", "Å¼": "z", "Å¾": "z", "áº“": "z", "áº•": "z", "Æ¶": "z", "È¥": "z", "É€": "z", "â±¬": "z", "ê£": "z", "Î†": "Î‘", "Îˆ": "Î•", "Î‰": "Î—", "ÎŠ": "Î™", "Îª": "Î™", "ÎŒ": "ÎŸ", "ÎŽ": "Î¥", "Î«": "Î¥", "Î": "Î©", "Î¬": "Î±", "Î­": "Îµ", "Î®": "Î·", "Î¯": "Î¹", "ÏŠ": "Î¹", "Î": "Î¹", "ÏŒ": "Î¿", "Ï": "Ï…", "Ï‹": "Ï…", "Î°": "Ï…", "Ï‰": "Ï‰", "Ï‚": "Ïƒ" } }), b.define("select2/data/base", ["../utils"], function(a) {
        ...
        return {
            inputTooLong: function(e) {
                var t = e.input.length - e.maximum,
                    n = "Vui lÃ²ng nháº­p Ã­t hÆ¡n " + t + " kÃ½ tá»±";
                return t != 1 && (n += "s"), n
            },
            inputTooShort: function(e) {
                var t = e.minimum - e.input.length,
                    n = "Vui lÃ²ng nháº­p nhiá»u hÆ¡n " + t + ' kÃ½ tá»±"';
                return n
            },
            loadingMore: function() { return "Äang láº¥y thÃªm káº¿t quáº£â€¦" },
            maximumSelected: function(e) { var t = "Chá»‰ cÃ³ thá»ƒ chá»n Ä‘Æ°á»£c " + e.maximum + " lá»±a chá»n"; return t },
            noResults: function() { return "KhÃ´ng tÃ¬m tháº¥y káº¿t quáº£" },
            searching: function() { return "Äang tÃ¬mâ€¦" }
        }
...
function buyPayPal() {
    swal({
            title: "",
            text: "Báº¡n sáº½ Ä‘Æ°á»£c chuyá»ƒn qua trang PAYPAL Ä‘á»ƒ hoÃ n táº¥t thanh toÃ¡n, vui lÃ²ng khÃ´ng Ä‘Ã³ng trÃ¬nh duyá»‡t sau khi hoÃ n thÃ nh giao dá»‹ch.",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
...
$(function() {
    $('#checkout').on('submit', function(e) {
        var $this = $(this);
        var phuongthucthanhtoan = $this.find('[name=phuongthucthanhtoan]:checked').val();
        e.preventDefault();
        if (phuongthucthanhtoan == 1) {
            // Lay mang khach hang
            var frmCustomer = $('#checkout'),
                dienthoai = frmCustomer.find('[name=dienthoai]').val(),
                hoten = frmCustomer.find('[name=hoten]').val(),
                email = frmCustomer.find('[name=email]').val(),
                diachi = frmCustomer.find('[name=diachi]').val(),
                ghichu = frmCustomer.find('[name=ghichu]').val();
            if (dienthoai != null) {
                $.ajax({
                    url: _link + 'ajax/',
                    cache: false,
                    ...
                    success: function(response) {
                        if (response) {
                            ...
                            swal('CÃ³ lá»—i xáº£y ra, vui lÃ²ng thá»­ láº¡i', '', 'error');
                        }
                    }
                });
            } else {
                swal('Vui lÃ²ng nháº­p sá»‘ Ä‘iá»‡n thoáº¡i', 'Sá»‘ Ä‘iá»‡n thoáº¡i cáº§n nháº­p chÃ­nh xÃ¡c Ä‘á»ƒ chÃºng tÃ´i gá»i xÃ¡c nháº­n Ä‘Æ¡n hÃ ng.', 'warning');
            }
        } else {
            $this.unbind().submit();
        }
...
function notifi(mess, type = 'danger') {
    var cont = `
    ...
    `);
    setTimeout(function() {
        $("body").find(".ws-notifi").slideUp();
    }, 4e3);
}
$(function() {

    $('#xoaKhuyenMai').on('click', function() {
        $.get(_link + 'ajax/?method=xoakhuyenmai', function() {
            location.reload();
        });
    });


    $("#btn_change_ma").on('click', function() {
        $(this).closest(".input-group").addClass('hide');
        $(this).closest(".input-group").next().removeClass('hide');
    });

    // Nut Ap dung ma khuyen mai
    $(document).on('click', '#btn_giamgia', function() {
        var val = $(this).parent().prev();
        if (!val.val().length) {
            notifi('<h4>Vui lÃ²ng nháº­p mÃ£ giáº£m giÃ¡</h4>');
        } else {
            $.getJSON(_link + 'ajax/?method=makhuyenmai&value=' + val.val(),
                function(data) {
                    if (data) {
                        ...
                        if (data.message) {
                            notifi(data.message, data.status);
                        }
                    }
                });
        }
...
$(function() {
    ...
    $('.search-fixed').on('click', function(e) {
        if (e.target !== this)
            return;
    ...
    $('.icon-search').on('click', function() {
        ...
        $('.search-fixed').toggleClass('opened');
    });

    $(document).on('click', '#datTourBtn', function() {
        var errors = empty = false;
        var mess = null;
        $("#datTourFrm input").each(function(index, el) {
            // element == this
            ...
            if (name == 'sodienthoai' && !empty) {
                if (isNaN($(el).val()) || $(el).val().length < 10) {
                    mess = 'Vui lÃ²ng nháº­p sá»‘ Ä‘iá»‡n thoáº¡i';
                    $(el).parent().addClass('has-error');
                    errors = true;
                } else {
                    $(el).parent().removeClass('has-error');
                }
            } else if (name == 'email' && !empty) {
                if (!isMail($(el).val())) {
                    mess = 'Vui lÃ²ng nháº­p Ä‘á»‹a chá»‰ email';
                    $(el).parent().addClass('has-error');
                    errors = true;
                } else {
                    $(el).parent().removeClass('has-error');
        ...
        if (!errors && !empty) {
            var data = JSON.stringify(
                $("#datTourFrm input, #datTourFrm textarea").serializeObject()
            );
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response) {
                        var mgs = response.message ? response.message : 'CÃ³ lá»—i xáº£y ra, vui lÃ²ng thá»­ láº¡i.';
                        var status = response.status ? response.status : 'success';
            ...
            if (!mess) mess = 'Vui lÃ²ng nháº­p Ä‘á»§ thÃ´ng tin'
        }
...
// element alway square
jQuery(window).resize(function() {
    var ratio = (165 / 270); // height / width
    jQuery('.pictureRun img').height(jQuery('.pictureRun img').width() * ratio);
});
...
var offset_wscontainer = $('.ws-container').offset();
var offset_left = offset_wscontainer.left;
$('#wapper_banner .social .search-box').css("right", offset_left);
...
$(function() {
    $('a[data-toggle="tab2"]').parent('li').on('click', function(e) {
        var target = $(this).children('a').attr("data-target") // activated tab

        if ($('.tab-pane').not($(target)).hasClass('active')) {

            $('.tab-pane').not($(target)).removeClass('active');
            $('.tab-pane').not($(target)).removeClass('in');
        }
        ...
        $('.nav-tabs').children('li').not(this).removeClass('active');
...
$(function() {
    ...
    if (jQuery().DataTable) {
        $('#cftable').DataTable({
            ...
            lengthMenu: [
                [5, 10, 15, 20, -1],
                [5, 10, 15, 20, "Táº¥t cáº£"]
            ]
        });
    }
});
$(function() {
    $('#btnDatxe').live('click', function() {
        var frm = '#frmDatxe';
        var btn = $(this);
            ...
            callback: function(data) {
                if (data == 0) {
                    ...
                    var aray = JSON.stringify(
                        $(frm + " input, " + frm + " select, " + frm + " textarea").serializeObject()
                    );
...
function datxe(t) {
    var jd = $(t).data('id');
    var dm = $(t).data('dm');
    $.getJSON(_link + 'ajax/?method=datxe&id=' + jd + '&dm=' + dm, function(json, textStatus) {
    ...
    $.getJSON(url, {
        ...
        if (data.error != "success") {
            if (data.error == "quantity_unknown") {
                swal("Sá»‘ lÆ°á»£ng khÃ´ng há»£p lá»‡!", "", "error");
                self.location.href = '';
            }
        } else {
...
$(window).scroll(function() {
    ...
    if ($(document).width() > 768) {
        var _hei = $('#wapper_menu').outerHeight();
        var $classFixed = $('.menu-container');
        if (_top >= _hei) {
...
$(document).ready(function() {
    ...
    //     // CÃ‚U Lá»†NH NÃ€Y Sáº¼ ADD CLASS THEMKHUNG VÃ€O LI NÃ€O ÄÆ¯á»¢C Báº¤M VÃ€ XÃ“A THEMKHUNG NHá»®NG LI CÃ’N Láº I
    ...
    //                     alert('sai');
    //                 }else{
    //                     // Äá»” Káº¾T QUáº¢ VÃ€O THáºº HTML PHÃA TRÆ¯á»šC, VÃ Dá»¤ á»ž ÄÃ‚Y LÃ€ .PRODUCTBOX
    ...
    // gui dang ky don hang
    $('#dkdonhang').live('click', function(e) {
        // e.preventDefault();
        $(this).button('loading');
        var hoten = $('#frm-dkdonhang input[name=hoten]');
        var sdt = $('#frm-dkdonhang input[name=sdt]');
        if (!(hoten.val().length)) {
            // Chua nhap Email
            $(this).button('reset');
            $(hoten).val('');
            swal('Vui lÃ²ng nháº­p há» tÃªn Ä‘á»ƒ tiáº¿p tá»¥c', '', 'warning');
        } else if (!sdt.val().length) {
            // Chua nhap Email
            $(this).button('reset');
            $(sdt).val('');
            swal('Vui lÃ²ng nháº­p SÄT Ä‘á»ƒ tiáº¿p tá»¥c', '', 'warning');
        } else {
            $(this).button('reset');
            var form = $('#frm-dkdonhang').serialize();
            $.ajax({
                url: _link + 'ajax/?' + form,
            }).done(function(data) {
                swal(data, '', 'success');
    ...
    $('#dkmailBtn').on('click', function() {
        ...
        var _hoten = $('.frm-bottom').find('input[name=hoten]');
        var _sodienthoai = $('.frm-bottom').find('input[name=sodienthoai]');
        if (_input.val().length) {
            if (isMail(_input.val())) {
                ...
                $('#dkmailBtn').button('reset');
                $('.frm-bottom').find('input').val('');
                swal('Vui lÃ²ng nháº­p má»™t email há»£p lá»‡', '', 'warning');
            }
        } else {
            // Chua nhap Email
            $('#dkmailBtn').button('reset');
            $('.frm-bottom').find('input').val('');
            swal('Vui lÃ²ng nháº­p email Ä‘á»ƒ tiáº¿p tá»¥c', '', 'warning');
        }
    });

    // @ Dang Ky Nhan Mail á»ž GÃ“C PHáº¢I
    $('#dkmailBtn2').live('click', function() {
        ...
        if (_input.val().length) {
            ...
            $('#dkmailBtn2').button('reset');
            $(_input).val('');
            swal('Vui lÃ²ng nháº­p sá»‘ Ä‘iá»‡n thoáº¡i Ä‘á»ƒ tiáº¿p tá»¥c', '', 'warning');
        }
    });
    ...
    if ($.isFunction($.fn.owlCarousel)) {
        ...
        $('.doitacRun').owlCarousel({
            nav: false,
            dots: false,
            rtl: false, //cháº¡y xuÃ´i or ngÆ°á»£c
            margin: 20,
            loop: false,
            autoplay: true,
    ...
    try {
        ...
        h.onreadystatechange = function() {
            if (h.readyState == 4)
                ...
                } else alert("KhÃ´ng láº¥y dá»¯ liá»‡u Ä‘Æ°á»£c. " + h.statusText + "-" + h.responseText);
        }
        h.open("GET", url);
        h.send(null);
    } catch (e) {
        alert("Lá»—i " + e.description + "-" + h.responseText);
    }
}
...
function GetPage(pagename, div) {
    document.getElementById(div).innerHTML = "<span style='color:#000000;'><img src='images/icon/loading19.gif' /> Äang táº£i dá»¯ liá»‡u </span>";
    url = pagename;
    try {
        var h;
        if (window.ActiveXObject) h = new ActiveXObject("Microsoft.XMLHTTP");
...
function checkorder() {
    if (document.form_order.diadiem.value == '') {
        alert("Báº¡n chÆ°a nháº­p Ä‘á»‹a Ä‘iá»ƒm giao hÃ ng.");
...
function goilai(url, div, id, link, sodienthoaikhongdung, thongbao) {
    if (document.getElementById('txtgoilai').value == "" || isNaN(document.getElementById('txtgoilai').value) || document.getElementById('txtgoilai').value.length <= 6) document.getElementById('ycgoilai').innerHTML = '<span style="color:#F00;padding:3px">' + sodienthoaikhongdung + '</span>';
        ...
        document.getElementById(div).innerHTML = '<span style="color:#000; width: 100%; display: block; text-align: center; padding: 0px; font-size: 120%;"><img src="./templates/images/loading.gif"/><br> Äang gá»­i ...</span>';
        var request = $.ajax({
            type: "POST",
            url: url,
            data: {
...
function goilai2(url, div, id, link, sodienthoaikhongdung, thongbao) {
    if (document.getElementById('txtgoilai2').value == "" || isNaN(document.getElementById('txtgoilai2').value) || document.getElementById('txtgoilai2').value.length <= 6) document.getElementById('ycgoilai2').innerHTML = '<span style="color:#F00;padding:3px">' + sodienthoaikhongdung + '</span>';
        ...
        document.getElementById(div).innerHTML = '<span style="color:#000; width: 100%; display: block; text-align: center; padding: 0px; font-size: 120%;"><img src="./application/templates/images/loading.gif"/><br> Äang gá»­i ...</span>';
        var request = $.ajax({
            type: "POST",
            url: url,
            data: {
